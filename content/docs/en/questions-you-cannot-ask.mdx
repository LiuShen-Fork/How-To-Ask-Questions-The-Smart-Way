...
## Do Not Hand Your Search Task to Others
...
## Reluctance to read basic documentation
...
## Unwilling to do minimal experimentation on their own
...
## No description of the specific problem
...
## Throwing Platform Problems at Irrelevant People
...
## Allegations of faulty underlying tools without evidence
...
## Issues requiring on-site operation
...
## Requests for unlawful or malicious acts
