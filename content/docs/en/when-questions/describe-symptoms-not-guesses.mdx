---
title: Describe the symptoms of the problem rather than your guesses
...
## Give Evidence Before Speculation
...
## Counter-example: jumping to premature conclusions
...
## Good example: describing observable phenomena
