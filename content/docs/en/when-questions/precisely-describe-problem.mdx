---
title: Precise description of the problem
...
## Information to be written clearly
...
## Pre-answer possible follow-up questions
...
## Reproducible environments are particularly important
...
[Simon Tatham](http://www.chiark.greenend.org.uk/~sgtatham/) has written an excellent article called "[How to report bugs effectively](http://www.chiark.greenend.org.uk/~sgtatham/bugs-cn .html)" excellent article. Highly recommend you read it as well.
