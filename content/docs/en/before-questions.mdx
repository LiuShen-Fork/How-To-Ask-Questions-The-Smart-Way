...
- Try to find an answer by searching the archives of the
...
error message you get (searching [Google groups](http://groups.google.com/) as well as Web
...
anything that looked promising" is a good thing to do in e-mail
...
question...", and hoping the experience of getting what
...
example missing?", and "What site should I have
checked?" are more likely to get answered than "Please
post the exact procedure I should use." because you're making it
